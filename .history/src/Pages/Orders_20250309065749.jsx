    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0">
                <h2 className="text-2xl font-semibold text-gray-800">{t('Orders.Management')}</h2>)}</h2>
                ...
                >
                    ...
                    <span>{t('Orders.NewOrder')}</span>der')}</span>
                </Button>
            </div>
            ...
            <Modal
                ...
                title={t('Orders.CreateNewOrder')}ewOrder')}
            ...
            >
                <Card hover className="text-center p-4 transition-all duration-300 hover:-translate-y-1 border-b-4 border-blue-500">
                    <h3 className="text-sm text-gray-500">Total Orders</h3>rders')}</h3>
                ...
                <Card hover className="text-center p-4 transition-all duration-300 hover:-translate-y-1 border-b-4 border-green-500">
                    <h3 className="text-sm text-gray-500">Completed</h3>pleted')}</h3>
                ...
                <Card hover className="text-center p-4 transition-all duration-300 hover:-translate-y-1 border-b-4 border-yellow-500">
                    <h3 className="text-sm text-gray-500">Processing</h3>essing')}</h3>
                ...
                <Card hover className="text-center p-4 transition-all duration-300 hover:-translate-y-1 border-b-4 border-purple-500">
                    <h3 className="text-sm text-gray-500">Pending</h3>ending')}</h3>
                ...
                <Card hover className="text-center p-4 transition-all duration-300 hover:-translate-y-1 border-b-4 border-red-500">
                    <h3 className="text-sm text-gray-500">Cancelled</h3>celled')}</h3>
                ...
                <Card hover className="text-center p-4 transition-all duration-300 hover:-translate-y-1 border-b-4 border-indigo-500">
                    <h3 className="text-sm text-gray-500">Total Revenue</h3>venue')}</h3>
            ...
            >
                <Card hover className="p-4">
                    <div className="flex items-center gap-2">
                        ...
                        <input 
                            type="text"
                            placeholder="Search orders"chOrders')}
                            className="w-full p-2 border rounded-lg focus:ring-1 focus:ring-gray-500 transition-colors duration-300"
                            value={searchTerm}
                ...
                <Card hover className="p-4">
                    <div className="flex items-center gap-2">
                        ...
                        >
                            <option value="all">All Statuses</option>s')}</option>
                            <option value="completed">{t('Status.Completed')}</option>
                            <option value="processing">{t('Status.Processing')}</option>
                            <option value="pending">{t('Status.Pending')}</option>
                            <option value="cancelled">{t('Status.Cancelled')}</option>
                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ID</th>ers.ID')}</th>
                ...
                {filteredOrders.length > 0 && (
                    <div className="flex items-center justify-between border-t border-gray-200 px-6 py-3">
                        <div className="text-sm text-gray-500">
                            {t('Showing')} <span className="font-medium">{filteredOrders.length}</span> {t('of')} <span className="font-medium">{orders.length}</span> {t('Orders.Items')}ders.Items')}
                        </div>
                        <div className="flex space-x-2">
