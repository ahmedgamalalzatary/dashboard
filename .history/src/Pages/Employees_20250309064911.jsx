...
function Employees() {
    ...
    const [employees, setEmployees] = useState([
        { id: 1, name: t('Team.JohnSmith'), email: 'john.smith@example.com', phone: '555-1234', department: t('Departments.Sales'), position: t('Positions.Manager'), startDate: '2020-03-15', status: 'active' },
        { id: 2, name: t('Team.SarahJohnson'), email: 'sarah.j@example.com', phone: '555-2345', department: t('Departments.Marketing'), position: t('Positions.Specialist'), startDate: '2021-06-22', status: 'active' },
        { id: 3, name: t('Team.MichaelBrown'), email: 'michael.b@example.com', phone: '555-3456', department: t('Departments.IT'), position: t('Positions.Developer'), startDate: '2019-11-03', status: 'active' },
        { id: 4, name: t('Team.EmilyDavis'), email: 'emily.d@example.com', phone: '555-4567', department: t('Departments.HR'), position: t('Positions.Director'), startDate: '2018-05-17', status: 'inactive' },
        { id: 5, name: t('Team.DavidWilson'), email: 'david.w@example.com', phone: '555-5678', department: t('Departments.Finance'), position: t('Positions.Analyst'), startDate: '2022-01-10', status: 'active' },
    ]);
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0">
                <h2 className="text-2xl font-semibold text-gray-800">{t('Team.Management')}</h2>
            ...
            >
                <Card hover className="text-center p-4 transition-all duration-300 hover:-translate-y-1 border-b-4 border-blue-500">
                    <h3 className="text-sm text-gray-500">{t('Team.TotalMembers')}</h3>
                ...
                <Card hover className="text-center p-4 transition-all duration-300 hover:-translate-y-1 border-b-4 border-green-500">
                    <h3 className="text-sm text-gray-500">{t('Team.ActiveMembers')}</h3>
                ...
                <Card hover className="text-center p-4 transition-all duration-300 hover:-translate-y-1 border-b-4 border-red-500">
                    <h3 className="text-sm text-gray-500">{t('Team.InactiveMembers')}</h3>
                ...
                {filteredEmployees.length > 0 && (
                    <div className="flex items-center justify-between border-t border-gray-200 px-6 py-3">
                        <div className="text-sm text-gray-500">
                            {t('Showing')} <span className="font-medium">{filteredEmployees.length}</span> {t('of')} <span className="font-medium">{employees.length}</span> {t('Team.Members')}
                        </div>
                        <div className="flex space-x-2">
            ...
            >
                <Card hover className="p-6">
                    <h3 className="text-lg font-semibold text-gray-800 mb-4">{t('Team.DepartmentDistribution')}</h3>
                    <div className="space-y-4">
                        {Object.entries(employeeStats.departments).map(([dept, count]) => (
                            <div key={dept} className="space-y-1">
                                <div className="flex justify-between">
                                    <span className="text-gray-600">{dept}</span>
                                    <span className="text-gray-900">{count} {t('Team.Members')}</span>
                                </div>
                ...
                <Card hover className="p-6">
                    <h3 className="text-lg font-semibold text-gray-800 mb-4">{t('Team.RecentActivity')}</h3>
                    <div className="space-y-3">
                        <div className="p-3 rounded-lg border border-gray-100 hover:bg-gray-50 transition-colors duration-200">
                            <p className="font-medium text-gray-800">{t('Team.NewMemberJoined')}</p>
                            <p className="text-sm text-gray-500 mt-1">{t('TimeAgo.threedays')}</p>
                        </div>
                        <div className="p-3 rounded-lg border border-gray-100 hover:bg-gray-50 transition-colors duration-200">
                            <p className="font-medium text-gray-800">{t('Team.MemberPromoted')}</p>
                            <p className="text-sm text-gray-500 mt-1">{t('TimeAgo.fivedays')}</p>
                        </div>
                        <div className="p-3 rounded-lg border border-gray-100 hover:bg-gray-50 transition-colors duration-200">
                            <p className="font-medium text-gray-800">{t('Team.MemberLeft')}</p>
