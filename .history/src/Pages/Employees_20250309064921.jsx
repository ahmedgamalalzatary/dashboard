...
function Employees() {
    ...
    const [employees, setEmployees] = useState([
        { id: 1, name: t('JohnSmith'), email: 'john.smith@example.com', phone: '555-1234', department: t('Departments.Sales'), position: t('Positions.Manager'), startDate: '2020-03-15', status: 'active' },
        { id: 2, name: t('SarahJohnson'), email: 'sarah.j@example.com', phone: '555-2345', department: t('Departments.Marketing'), position: t('Positions.Specialist'), startDate: '2021-06-22', status: 'active' },
        { id: 3, name: t('MichaelBrown'), email: 'michael.b@example.com', phone: '555-3456', department: t('Departments.IT'), position: t('Positions.Developer'), startDate: '2019-11-03', status: 'active' },
        { id: 4, name: t('EmilyDavis'), email: 'emily.d@example.com', phone: '555-4567', department: t('Departments.HR'), position: t('Positions.Director'), startDate: '2018-05-17', status: 'inactive' },
        { id: 5, name: t('DavidWilson'), email: 'david.w@example.com', phone: '555-5678', department: t('Departments.Finance'), position: t('Positions.Analyst'), startDate: '2022-01-10', status: 'active' },
    ]);
                ...
                {filteredEmployees.length > 0 && (
                    <div className="flex items-center justify-between border-t border-gray-200 px-6 py-3">
                        <div className="text-sm text-gray-500">
                            {t('Showing')} <span className="font-medium">{filteredEmployees.length}</span> {t('of')} <span className="font-medium">{employees.length}</span> {t('Employees.Staff')}
                        </div>
                        <div className="flex space-x-2">
                        ...
                        {Object.entries(employeeStats.departments).map(([dept, count]) => (
                            <div key={dept} className="space-y-1">
                                <div className="flex justify-between">
                                    ...
                                    <span className="text-gray-900">{count} {t('Employees.TeamMembers')}</span>
                                </div>
