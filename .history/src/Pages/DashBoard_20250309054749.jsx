...
function DashBoard({ setActivePage }) {
    ...
    // More direct navigation function to handle all navigation needs
    const navigateTo = useCallback((page) => {
        // Set a flag in local storage to ensure the navigation persists
        localStorage.setItem('activePage', page);
        
        // Debug log
        console.log(`NAVIGATION: Changing page to ${page}`);
        
        // Direct and immediate call to setActivePage
        setActivePage(page);
    ...
    useEffect(() => {
        ...
        // Log what happens when we try to call it
        const testNav = () => {
            try {
        ...
        // Run test after component is fully mounted
        const timer = setTimeout(testNav, 1000);
                                ...
                                <Button
                                    ...
                                    onClick={() => {
                                        ...
                                        if (action.action === 'navigation') {
                                            // Direct navigation with no timeout
                                    ...
                                    icon={<action.icon className="text-gray-600" />}
