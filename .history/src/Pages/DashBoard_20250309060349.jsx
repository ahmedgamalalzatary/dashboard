...
function DashBoard({ setActivePage: _ }) {  // Rename to underscore to indicate it's deliberately unused
    ...
    // Simple function to show notification without navigation
    const showNotificationOnly = useCallback((message) => {
        showTemporaryNotification(message || 'Feature coming soon');
                    ...
                    <Card hover>
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <Button
                                variant="secondary"
                                size="sm"
                                onClick={() => showNotificationOnly('Viewing all sales transactions')}
                            >
                                {t('ViewAll')}
                            </Button>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {quickActions.map(action => (
                                <Button
                                    key={action.label}
                                    variant="secondary"
                                    onClick={() => showNotificationOnly(
                                        action.action === 'navigation' 
                                            ? `Navigate to ${action.page} (feature coming soon)` 
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-lg p-6 text-white">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        <Button
                            variant="light"
                            onClick={() => showNotificationOnly('Opening chat support (feature coming soon)')}
                        ...
                        <Button
                            variant="ghost"
                            onClick={() => showNotificationOnly('Opening call support (feature coming soon)')}
