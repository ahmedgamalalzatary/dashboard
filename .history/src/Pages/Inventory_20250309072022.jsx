                                ...
                                filteredInventory.map((item, idx) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className={`px-2 py-1 rounded-full text-xs ${item.category === t('Categories.Electronics') ? 'bg-blue-100 text-blue-800' :
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className={`flex items-center px-2 py-1 rounded-full text-xs ${item.status === 'in-stock' ? 'bg-green-100 text-green-800' :
