...
import { MdAddCircle, MdSearch, MdFilterList, MdEdit, MdDelete, MdMoreVert } from 'react-icons/md';
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0">
                <h2 className="text-2xl font-semibold text-gray-800">{t('orders')}</h2>
            ...
            >
                <Card hover className="text-center p-4 transition-all duration-300 hover:-translate-y-1 border-b-4 border-blue-500">
                    <h3 className="text-sm text-gray-500">{t('Orders.TotalOrders')}</h3>
                ...
                <Card hover className="text-center p-4 transition-all duration-300 hover:-translate-y-1 border-b-4 border-green-500">
                    <h3 className="text-sm text-gray-500">{t('Orders.Completed')}</h3>
                ...
                <Card hover className="text-center p-4 transition-all duration-300 hover:-translate-y-1 border-b-4 border-yellow-500">
                    <h3 className="text-sm text-gray-500">{t('Orders.Processing')}</h3>
                ...
                <Card hover className="text-center p-4 transition-all duration-300 hover:-translate-y-1 border-b-4 border-purple-500">
                    <h3 className="text-sm text-gray-500">{t('Orders.Pending')}</h3>
                ...
                <Card hover className="text-center p-4 transition-all duration-300 hover:-translate-y-1 border-b-4 border-red-500">
                    <h3 className="text-sm text-gray-500">{t('Orders.Cancelled')}</h3>
                ...
                <Card hover className="text-center p-4 transition-all duration-300 hover:-translate-y-1 border-b-4 border-indigo-500">
                    <h3 className="text-sm text-gray-500">{t('Orders.TotalRevenue')}</h3>
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {filteredOrders.length > 0 ? (
                                ...
                                <tr>
                                    <td colSpan="8" className="px-6 py-4 text-center text-gray-500 py-8">
                ...
                {filteredOrders.length > 0 && (
                    <div className="flex items-center justify-between border-t border-gray-200 px-6 py-3">
                        <div className="text-sm text-gray-500">
                            {t('Showing')} <span className="font-medium">{filteredOrders.length}</span> {t('of')} <span className="font-medium">{orders.length}</span> {t('orders')}
                        </div>
                        <div className="flex space-x-2">
