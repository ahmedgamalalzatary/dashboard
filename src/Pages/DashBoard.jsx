...
function DashBoard({ setActivePage }) {
    ...
    // Use the new translation pattern for months
    const data = [
        { name: t('Months.Jan'), sales: 4000, orders: 2400, revenue: 2400 },
        { name: t('Months.Feb'), sales: 3000, orders: 1398, revenue: 2210 },
        { name: t('Months.Mar'), sales: 2000, orders: 9800, revenue: 2290 },
        { name: t('Months.Apr'), sales: 2780, orders: 3908, revenue: 2000 },
        { name: t('Months.May'), sales: 1890, orders: 4800, revenue: 2181 },
                    ...
                    <Card hover>
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <div className="flex space-x-2">
                                <Button variant="ghost" size="xs" className="bg-gray-100 text-gray-700">{t('Timeframes.Weekly')}</Button>
                                <Button variant="dark" size="xs">{t('Timeframes.Monthly')}</Button>
                                <Button variant="ghost" size="xs" className="bg-gray-100 text-gray-700">{t('Timeframes.Yearly')}</Button>
                            </div>
                        </div>
                        <div className="h-64">
                                    ...
                                    <div className="w-full bg-gray-200 rounded-full h-2">
                                        <div
                                            className={`h-2 rounded-full ${
                                                item.name === t('SalesChannels.Online') ? 'bg-blue-600' :
                ...
                <div className="lg:col-span-2">
                    <Card hover>
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <Button variant="secondary" size="sm">{t('ViewCalendar')}</Button>
                        </div>
